#!/usr/bin/env python3
"""
Tutorial: How to work with CAMEL HDF5 snapshots

This script demonstrates key techniques for exploring and analyzing
simulation data.
"""
...
filepath = 'data/IllustrisTNG/LH/LH_0/snap_080.hdf5'
...
# ============================================================================
# TECHNIQUE 5: Computing statistics without loading full array
# ============================================================================
...
# ============================================================================
# TECHNIQUE 6: Understanding units and physical quantities
# ============================================================================
...
# ============================================================================
# TECHNIQUE 7: Filtering and selecting particles
# ============================================================================
...
# ============================================================================
# TECHNIQUE 8: Visualizing spatial distribution
# ============================================================================
...
with h5py.File(filepath, 'r') as f:
    ...
    plt.tight_layout()
    output = 'plots/camel_snapshot_exploration.png'
...
Next steps:
- Run this script: python explore_camel.py
- Modify it to explore other fields
- Ready to generate spectra with fake_spectra!
""")
